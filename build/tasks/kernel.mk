...
# Define custom ccache dir for kernel
ifneq ($(KERNEL_CCACHE_DIR),)
    KERNEL_CCACHE := CCACHE_DIR="$(KERNEL_CCACHE_DIR)"
endif
...
define internal-make-kernel-target
    $(PATH_OVERRIDE) $(KERNEL_MAKE_CMD) $(KERNEL_MAKE_FLAGS) -C $(KERNEL_SRC) O=$(KERNEL_BUILD_OUT_PREFIX)$(1) ARCH=$(KERNEL_ARCH) $(KERNEL_CROSS_COMPILE) $(KERNEL_CLANG_TRIPLE) $(KERNEL_CCACHE) $(KERNEL_CC) $(KERNEL_LD) $(2)
endef
